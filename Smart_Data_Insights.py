...
st.write(f"Selected KPI Column: **{kpi_col}**")

c1, c2, c3 = st.columns(3)

c1.metric("📈 Average Value", round(data[kpi_col].mean(), 2))
c2.metric("🔝 Maximum Value", data[kpi_col].max())
c3.metric("🔻 Minimum Value", data[kpi_col].min())
